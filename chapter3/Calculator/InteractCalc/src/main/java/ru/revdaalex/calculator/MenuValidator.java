...
public class MenuValidator {
    ...
    /**
     * Validation engineer menu.
     * @return int user choice in menu.
     */
    public int validEngineerMenu(){
        int choice = 0;
        isValid = true;
        while (isValid) {
            this.uc = Integer.valueOf(this.io.read());
    ...
    /**
     * Validation engineer operation.
     * @return int number of operation.
     */
    public int validEngineerOperation(){
        int choice = 0;
        isValid = true;
        while (isValid) {
            this.uc = Integer.valueOf(this.io.read());
